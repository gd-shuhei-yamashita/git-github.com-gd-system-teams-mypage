...
class SyncContractCodeByCustomerCodeAndPlan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync_contract_code_by_customer_code_and_plan';
    ...
    public function handle()
    {
        try {
            ...
            ->whereNull('pps_type')
            ->whereIn('supplypoint_code', ['0', '1', '2', '3', '4', '5', 'key', ''])
            ->limit(100000)
            ->get();
