...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'email'        => 'メールアドレス',
        'password'     => 'パスワード',
        'email_new' => '新しいメールアドレス',
        'email_new_confirm' => '新しいメールアドレス（確認）',
        'password_new' => '新しいパスワード',
        'password_new_confirm' => '新しいパスワード（確認）',

        'notice_date'    => 'お知らせ日付',
        'url'            => 'URL入力',
        'notice_comment' => 'お知らせ内容',

        'parent_customer_code' => '(親)マイページID',
        'child_customer_code'  => '(子)マイページID',
        'change_result'        => '変更詳細',

        'name'            => 'お名前',
        'customer_code'   => 'マイページID',

        'supplypoint_code'                => '供給地点特定番号',
        'assignment_before_customer_code' => '譲渡元マイページID',
        'assignment_after_customer_code'  => '譲渡先マイページID',
        'assignment_date'                 => '譲渡日',
        'before_customer_billing_end'     => '最終請求年月',
        'after_customer_billing_start'    => '初回請求年月',

        'now_customer_code' => 'マイページID(旧)',
        'new_customer_code' => 'マイページID(新)',
        'now_supplypoint_code' => '供給地点特定番号(旧)',
        'new_supplypoint_code' => '供給地点特定番号(新)',
    ],
